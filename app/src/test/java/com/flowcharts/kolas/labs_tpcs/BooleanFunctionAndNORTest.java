 ...
 */
public class BooleanFunctionAndNORTest {
    BooleanFunctionAndNOR mBooleanFunctionAndNOR;
    ...
    public void setUp() throws Exception {
        ...
        mBooleanFunctionAndNOR = new BooleanFunctionAndNOR(s);
    }
    ...
    public void cropString() throws Exception {
        ...
        assertEquals(mBooleanFunctionAndNOR.cropString(s), res);
        assertEquals(mBooleanFunctionAndNOR.deleteNot(sf), res);

    }

    @Test
    public void createAndNor() throws Exception {
        ArrayList<String> pre = mBooleanFunctionAndNOR.functions;
        assertEquals(pre, mBooleanFunctionAndNOR.functions);
    }

    @Test
    public void normalizeAND() {
        String s = "not(a)•v•not(s)•g•w";
        String res = "(not(a)•v•not(s))•(g•w)";
        assertEquals(res,mBooleanFunctionAndNOR.normalizeAND(s));
    }

    @Test
    public void normalizeOR() {
        String s = "(f•v•s)▼(a•v•d)▼(a•g•w)";
        String res = "((f•v•s)▼(a•v•d))▼(a•g•w)";
        assertEquals(res,mBooleanFunctionAndNOR.normalizeOR(s));
    }
    @Test
    public void generate3And2NorView() {

        mBooleanFunctionAndNOR.generate3And2NorView();
        assertEquals("",mBooleanFunctionAndNOR.functions);
    }
